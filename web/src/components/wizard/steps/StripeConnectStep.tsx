...
export default function StripeConnectStep({
  ...
  return (
    <WizardStep
      ...
      description="Stripe data helps PulseScore evaluate billing reliability, failed payments, and MRR trends."
    >
      <p className="text-sm text-[var(--galdr-fg-muted)]">
        We request read-only access to customer, subscription, and payment data.
      </p>

      <div className="galdr-panel mt-4 p-4">
